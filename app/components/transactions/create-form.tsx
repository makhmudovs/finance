...
import { createTransaction, CreateTransactionState } from "@/app/lib/transaction-actions";
...
export function Form() {
  ...
  return (
    <>
      <h1 className="text-2xl mb-4">Add a new Transaction</h1>
      <form
        action={action}
        className="w-full mx-auto max-w-lg bg-muted/50 p-4 rounded-lg"
      >
        <FieldGroup>
          <Field>
